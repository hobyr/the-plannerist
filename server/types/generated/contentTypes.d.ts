...
export interface ApiAccompagnementAccompagnement
  ...
  attributes: {
    ...
    faq: Schema.Attribute.DynamicZone<
      ['shared.faq', 'shared.rich-text', 'shared.call-to-action']
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiBusinessCaseBusinessCase
  ...
  attributes: {
    accompagnement: Schema.Attribute.Component<
      'business-cases.accompagnement',
      false
    > &
    ...
    auditCover: Schema.Attribute.Media<
    ...
    auditDescription: Schema.Attribute.Blocks &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    contexte: Schema.Attribute.Blocks &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
